...
{
	m_Cipher_C2S = new Cipher_AES_Encrypt(keys.GetInitialIV_C2S(), keys.GetEncryptionKey_C2S(), keys.GetKeySize());
	m_Cipher_S2C = new Cipher_AES_Decrypt(keys.GetInitialIV_S2C(), keys.GetEncryptionKey_S2C(), keys.GetKeySize());
